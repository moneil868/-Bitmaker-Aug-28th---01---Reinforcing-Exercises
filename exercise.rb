...
puts "The last day of class is #{team_edi.last_day}"
puts
# puts "The following days are Coffee and Code: "
# puts team_edi.coffee_code_days
# puts
# puts "The following days are class days: "
# puts team_edi.class_days

puts team_edi.weeks_of_cohort.inspect
